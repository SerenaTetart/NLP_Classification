...
It might not be a good choice for an example since you might need to do feature engineering to make it work, but it works fine for 'normal' and 'toxic' data.
